...
export default function HomePresentation({ age, workingTime }) {
	return (
		<>
			...
			<div className="body-half pres-cv">
				<a rel="noopener noreferrer" target="_blank" href="https://01.cdn.elanis.eu/portfolio/pdf/CV_Axel_Soupe_Elanis_EN.pdf"><img src="img/pdf.webp" alt="cv_en" /> <span>Resume (English)</span></a>
			</div>
		</>
	);
}
